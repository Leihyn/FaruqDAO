...
export default function Home() {
  ...
  // Fetch the FaruqDAO NFT balance of the user
  const nftBalanceOfUser = useReadContract({
    abi: DaoNFTABI,
    address: DaoNFTAddress,
  ...
  return (
    <div className={inter.className}>
      <Head>
        <title>Faruq DAO</title>
        <meta name="description" content="Faruq DAO" />
        <link rel="icon" href="/favicon.ico" />
      </Head>

      <div className={styles.main}>
        <div>
          <h1 className={styles.title}>Welcome to Faruq DAO!</h1>
          <div className={styles.description}>Welcome to the DAO!</div>
          <div className={styles.description}>
            Your Faruq NFT Balance: {nftBalanceOfUser.data ? nftBalanceOfUser.data.toString() : 'Loading...'}
            <br />
            {daoBalance.data && (
              <>
